...
import './index.css';
import Startsite from "./components/Startsite/Startsite.jsx";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/startsite" element={<Startsite/>} /> {/* Die Namen der Seiten müssen groß geschrieben werden, damit das klappt*/}
